...
export class Client {
    ...
    async sendUserInput(taskId, requestId, userInput) {
        return await this.restClient.sendUserInput(
            taskId,
            requestId,
            userInput
        );
    ...
    async pollTaskStatusLoop(
        ...
        return await this.restClient.pollTaskStatusLoop(
            taskId,
            onUpdate,
            interval,
            stopSignal
    ...
    async connectWebSocket(taskId, onMessage = () => {}, onClose = () => {}) {
        ...
        this.websocketManager = new WebSocketManager(
            ...
            onMessage,
            async (event) =>
                await this._onClose(event, taskId, onMessage, onClose)
        );
